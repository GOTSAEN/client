    ...
    <section >
      {
        data && (
          ...
          <div className='text-sm'><span className='text-muted-foreground mr-1'>모집기간</span> {data?.startDate} ~ {data?.endDate}</div> 
          <p><span className='text-muted-foreground mr-1'>모집인원</span>  {data?.numberOfRecruit}</p> 
          </div>
