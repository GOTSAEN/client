        ...
        <Table>
          <TableHeader>
            <TableRow className="grid grid-cols-12 items-center">
              <TableHead className="col-span-4 ml-2">닉네임</TableHead>
              <TableHead className="col-span-4 justify-center ">카테고리</TableHead>
              <TableHead className="col-span-4 justify-end mr-4">문의하기</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {error && <p>Error</p>}
